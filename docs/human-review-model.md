...
It may automate bounded execution mechanics, validation support, artifact capture, and draft generation, but it must not remove the operator from judgment-heavy decisions.
